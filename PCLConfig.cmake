...
macro(find_libusb)
  if(NOT WIN32)
    find_path(LIBUSB-1.0_INCLUDE_DIRS
      NAMES libusb-1.0/libusb.h
      PATHS /usr/include /usr/local/include /opt/local/include /sw/include
      PATH_SUFFIXES libusb-1.0)

    find_library(LIBUSB-1.0_LIBRARIES
      NAMES usb-1.0
      PATHS /usr/lib /usr/local/lib /opt/local/lib /sw/lib)

    find_package_handle_standard_args(libusb-1.0 LIBUSB-1.0_LIBRARIES LIBUSB-1.0_INCLUDE_DIRS)
    
    if(LIBUSB-1.0_FOUND)
      get_filename_component(LIBUSB-1.0_LIBRARY_DIRS ${LIBUSB-1.0_LIBRARIES} PATH)
...
macro(find_pcap)
  ...
  if(EXISTS $ENV{PCAPDIR})
    find_path(PCAP_INCLUDE_DIRS
      ...
      PATHS $ENV{PCAPDIR} $ENV{PCAPDIR}/include
      NO_DEFAULT_PATH
    )
    find_library(PCAP_LIBRARIES
      NAMES ${_PCAP_LIBRARY_NAME}
      PATHS $ENV{PCAPDIR} $ENV{PCAPDIR}/lib
      NO_DEFAULT_PATH
    )
  ...
  if(PCAP_FOUND)
    get_filename_component(PCAP_LIBRARY_DIRS ${PCAP_LIBRARIES} PATH)
  endif(PCAP_FOUND)
endmacro(find_pcap)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/build/pcl-6_P28C/pcl-1.7.2")
...
set(pcl_all_components  common kdtree octree search io sample_consensus filters geometry features segmentation surface registration recognition keypoints visualization people outofcore tracking apps modeler in_hand_scanner point_cloud_editor )
